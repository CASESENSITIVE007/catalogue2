...
export default function Footer() {
  return (
    <footer className="bg-inverse-surface text-surface-variant w-full py-xl border-t border-outline/10">
      <Reveal className="max-w-7xl mx-auto px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row justify-between items-start gap-md">
        <div className="">
          <div className="font-display-lg text-headline-md font-bold text-primary-fixed tracking-tight mb-sm">
            Alif Global
          </div>
          <p className="font-body-md text-body-md text-surface-variant/70">
            ...
            intelligence and architecture since 2014.
          </p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-xl w-full md:w-auto">
          <div className="flex flex-col gap-sm">
            <h5 className="text-primary-fixed font-bold font-label-md text-label-md uppercase">
              Company
            </h5>
            <Link
      ...
      >
        <span className="font-body-md text-body-md text-surface-variant/70">
          © 2024 Alif Global. All Rights Reserved.
        </span>
